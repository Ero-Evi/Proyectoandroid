    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PagarImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PantallaMain.this, PantallaMain.class);
        ...
        MenuImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PantallaMain.this, Menu.class);
                startActivity(intent);
            }
        });
        ...
        ChatImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PantallaMain.this, Chat.class);
                startActivity(intent);
            }
        });
        ...
        MasImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PantallaMain.this, Mas.class);
                startActivity(intent);
            }
        });
    }
